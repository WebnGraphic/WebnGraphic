                ...
                <div className="flex justify-center">
                  <Calendar
                    ...
                    classNames={{
                      ...
                      day: "h-9 w-9 sm:h-10 sm:w-12 md:w-14 text-sm sm:text-base font-medium aria-selected:opacity-100 flex items-center justify-center",
                      head_cell:
                        "text-muted-foreground font-medium text-xs sm:text-sm w-9 h-8 sm:w-12 md:w-14 sm:h-10 flex items-center justify-center",
                      cell: "text-center cursor-pointer p-0 relative [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
                      nav_button:
                        "h-7 w-7 sm:h-9 top-0 sm:w-9 bg-transparent p-0 opacity-50 hover:opacity-100",
                      caption: "text-sm sm:text-base font-medium py-1 sm:py-2",
