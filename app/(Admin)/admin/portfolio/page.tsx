...
import PortfolioCreateButton from "../../Component/portfolio-create-button";
import AdminPortfolioList from "../../Component/portfolio-list";
  ...
  return (
    <div className="max-w-7xl w-full mx-auto px-5 py-10">
      <div className="flex flex-col gap-8">
        ...
        >
          <AdminPortfolioList search={search} page={currentPage} />
        </Suspense>
      </div>
    </div>
  );
